...
const strings_t strings[LANGUAGE_COUNT] = {
    ...
    [lang_chinese] = {
...
#ifdef ENABLE_ADDON_SWITCH_OFF_REMINDER
        .SWITCH_OFF_REMINDER_Title = "开关提醒",
        .SWITCH_OFF_REMINDER_EnableDisableOption = "提醒",
        .SWITCH_OFF_REMINDER_InactivityDelay = "延时",
        .SWITCH_OFF_REMINDER_ReminderPeriod = "时间",
        .SWITCH_OFF_REMINDER_TimeUnit = "m",
        .SWITCH_OFF_REMINDER_BeepType = "蜂鸣类型",
        ...
        .IRON_smartActiveEnable = "智能启动",
        .IRON_smartActiveLoad = "└ 负载",
        .IRON_Power = "功率限制",
        .IRON_Heater = "烙铁电阻",
        ...
        .IRON_Error_Resume_Mode = "└ 出错模式",
        .IRON_FILTER_MENU = "滤波设置",
        ...
        .SYSTEM_Remember = "记住最后选择",
        .SYSTEM_RememberLastProfile = "└ 烙铁类型",
        .SYSTEM_RememberLastTip = "└ 烙铁头",
#ifdef HAS_BATTERY
        .SYSTEM_RememberLastTemp = "└ 烙铁温度",
#endif
        ...
        .CAL_DELTA_HIGH_2 = "请手动调整",
        .CAL_DELTA_HIGH_3 = "再次开始设定",
        .CAL_Error = "发生错误!",
        .CAL_Aborting = "正在退出...",
        ...
        .ERROR_EXCEEDED = "数值超出",
        .ERROR_UNKNOWN = "未知错误",
        .ERROR_SYSTEM_HALTED = "系統奔溃",
        .ERROR_BTN_RESET = "使用按键重设",
